...
import com.daaniikusnanta.storyapp.databinding.ActivityCameraBinding
import com.daaniikusnanta.storyapp.misc.createFile
        ...
        imageCapture.takePicture(
            ...
            object : ImageCapture.OnImageSavedCallback {
                override fun onError(exc: ImageCaptureException) {
                    Toast.makeText(
                        this@CameraActivity,
                        getString(R.string.capture_picture_failed),
                        Toast.LENGTH_SHORT
                    ).show()
                }
